#
#  Be sure to run `pod spec lint OrientableViewController.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
                   A longer description of OrientableViewController in Markdown format.
  ...
  s.homepage     = "https://github.com/rapinto/OrientableViewController"
